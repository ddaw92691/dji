  ...
  const userMessages = ref<IUserMessageItem[]>([
    {
      ...
      content: 'The system will undergo maintenance from 22:00 to 24:00 tonight. It may be unavailable during this period. Please plan accordingly.',
      type: 'system',
      read: false,
    ...
    },
    {
      id: '2',
      title: 'David Fan',
      content: 'Your task list has been updated. Don\'t forget to drink some water 💧 before getting started!',
      type: 'user',
      read: false,
    ...
    },
    {
      ...
      content: 'The profile center is now live. You can manage your personal information and view message notifications.',
      type: 'system',
      read: false,
    ...
    },
    {
      id: '4',
      title: 'Alice L.',
      content: 'Your leaderboard progress has been updated. You are now in 2nd place. Go for it! 🏆',
      type: 'user',
      read: true,
    ...
    },
    {
      id: '6',
      title: 'Bob T.',
      content: 'Your friend leaderboard has just been updated. You are now in 3rd place. Keep it up! 🚀',
      type: 'user',
      read: false,
    ...
    },
    {
      id: '7',
      title: 'Charlie W.',
      content: 'Good luck today! You received a hidden easter egg 🎁 from the system. Go check it out!',
      type: 'user',
      read: false,
    ...
    {
      id: '8',
      title: 'Database Performance Optimization Notice',
      content: 'The database will undergo performance optimization at 23:00 tonight. Some services may experience brief fluctuations during this period.',
      type: 'system',
      read: false,
    ...
    },
    {
      id: '9',
      title: 'Eve K.',
      content: 'Don\'t forget the team coffee break ☕ this afternoon. Also, check who stole a bite of the cake 😂',
      type: 'user',
      read: false,
    ...
    },
    {
      id: '12',
      title: 'Grace M.',
      content: 'System reminder: Don\'t forget your exercise plan for today 🏃‍♀️. Stay healthy, stay happy!',
      type: 'user',
      read: false,
