...
// 默认角色
const rolePreset = ref<RolePreset>('merchant')
// 角色选项
const roleOptions: Array<{
...
}> = [
  {
    label: 'Merchant',
    value: 'merchant',
    preset: { username: 'merchant@example.com', password: 'merchant123456' },
  },
  { label: 'Agent', value: 'agent', preset: { username: 'agent@example.com', password: 'agent123456' } },
