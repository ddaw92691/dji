<template>
  <div class="i18n-page">
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? 'Edit Language' : 'Create Language'" width="550px" @close="resetForm">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="Name" prop="name">
          <el-input v-model="form.name" placeholder="Language name" />
        </el-form-item>
        <el-form-item label="Native Name" prop="nativeName">
          <el-input v-model="form.nativeName" placeholder="Native name" />
        </el-form-item>
        <el-form-item label="Code" prop="code">
          <el-input v-model="form.code" placeholder="en, zh-CN" />
        </el-form-item>
