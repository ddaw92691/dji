<template>
  <div class="i18n-page">
    ...
    <el-table :data="tableData" border stripe v-loading="loading" @selection-change="handleSelectionChange">
      <el-table-column prop="flagIcon" label="Flag" width="80" align="center" />
      <el-table-column prop="name" label="Name" min-width="140" show-overflow-tooltip />
      <el-table-column prop="code" label="Code" width="100" />
      <el-table-column prop="phoneCode" label="Phone Code" width="110" />
      <el-table-column prop="defaultLanguageCode" label="Default Language" width="150" show-overflow-tooltip />
      <el-table-column prop="currencyCode" label="Currency" width="100" />
      <el-table-column prop="currencySymbol" label="Symbol" width="90" />
      <el-table-column prop="timezone" label="Timezone" width="140" show-overflow-tooltip />
      <el-table-column prop="exchangeRate" label="Exchange Rate" width="130" align="right" />
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? 'Edit Country' : 'Create Country'" width="650px" @close="resetForm">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="160px">
        <el-form-item label="Name" prop="name">
          <el-input v-model="form.name" placeholder="Country name" />
        </el-form-item>
        <el-form-item label="Code" prop="code">
          <el-input v-model="form.code" placeholder="Country code (e.g. US)" />
        </el-form-item>
        <el-form-item label="Flag Icon" prop="flagIcon">
          <el-input v-model="form.flagIcon" placeholder="Flag icon class or emoji" />
        </el-form-item>
        <el-form-item label="Phone Code" prop="phoneCode">
          <el-input v-model="form.phoneCode" placeholder="+1" />
        </el-form-item>
        <el-form-item label="Default Language Code" prop="defaultLanguageCode">
          <el-input v-model="form.defaultLanguageCode" placeholder="en" />
        </el-form-item>
...
const rules: FormRules = {
  ...
  phoneCode: [{ required: true, message: 'Please enter phone code', trigger: 'blur' }],
  currencyCode: [{ required: true, message: 'Please enter currency code', trigger: 'blur' }],
  timezone: [{ required: true, message: 'Please enter timezone', trigger: 'blur' }],
