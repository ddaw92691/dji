...
const __VLS_1 = __VLS_asFunctionalComponent1(__VLS_0, new __VLS_0({
    key: (__VLS_ctx.motionKey),
    is: (__VLS_ctx.tag),
    initial: (__VLS_ctx.initial),
    hovered: (__VLS_ctx.hoverConfig),
    transition: (__VLS_ctx.transitionConfig),
...
(__VLS_ctx.$attrs);
/** @type {__VLS_StyleScopedClasses['animate-hover-wrapper']} */ ;
const { default: __VLS_5 } = __VLS_3.slots;
var __VLS_6 = {};
// @ts-ignore
[motionKey, tag, initial, hoverConfig, transitionConfig, $attrs,];
var __VLS_3;
// @ts-ignore
var __VLS_7 = __VLS_6;
// @ts-ignore
