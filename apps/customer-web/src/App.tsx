...
function App() {
  const { countryCode, languageCode, setLocale, setLocaleById, loadCountries } =
    useI18nStore();
  ...
  useEffect(() => {
    const onStorage = (event: StorageEvent) => {
      if (event.key === "mall_locale" && event.newValue) {
        setLocaleById(event.newValue);
      }
    };
  ...
  return (
    <div
      className={
        isFullWidthPage ? "min-h-screen bg-white" : "min-h-screen bg-gray-50"
      }
    >
      <div
        className={
          isFullWidthPage
            ...
            : "mx-auto max-w-[480px] min-h-screen bg-white shadow-sm"
        }
      >
        <Routes>
          ...
          <Route
            path="/store-day"
            element={<StoreCategoryPage section="store-day" />}
          />
          <Route
            path="/camera-drones"
            element={<StoreCategoryPage section="camera-drones" />}
          />
          <Route
            path="/handheld"
            element={<StoreCategoryPage section="handheld" />}
          />
          <Route
            path="/robot-vacuum"
            element={<StoreCategoryPage section="robot-vacuum" />}
          />
          <Route
            path="/services"
            element={<StoreCategoryPage section="services" />}
          />
          <Route
            path="/accessories"
            element={<StoreCategoryPage section="accessories" />}
          />
          <Route
            path="/education-industry"
            element={<StoreCategoryPage section="education" />}
          />
          <Route
            path="/official-refurbished"
            element={<StoreCategoryPage section="refurbished" />}
          />
