...
function mallStaticKey(text: string) {
  return `mall.static.${text
    .toLowerCase()
    .replace(/&/g, "and")
    .replace(/[^a-z0-9]+/g, ".")
    .replace(/^\.|\.$/g, "")}`;
...
function useMallT() {
  ...
  return (text?: string) => (text ? t(mallStaticKey(text), text) : "");
}
...
const homeAsset = {
  ...
  whatsNew: [
    {
      product: home("imgi_32_df537d7b13fd5aada161c63416d2b905.png"),
      bg: home("imgi_33_16f3c4fc8f2fb372fa111240ec9ad141.jpg"),
      color: "#b8c451",
    },
    {
      product: home("imgi_34_4f349c761d049befad1545deb0f26621.png"),
      bg: home("imgi_35_4f99c42b87409f04533c0f352412cb94.jpg"),
      color: "#e1ae76",
    },
    {
      product: home("imgi_36_8a285ec398e3d92c2486a053f1674196.png"),
      bg: home("imgi_37_a6f97e37a70582aac62af4b1fdca06a6.jpg"),
      color: "#466941",
    },
    {
      product: home("imgi_38_f56e1f1f6cecb5cae9b35c83741ce0f4.png"),
      bg: home("imgi_39_6d914404e9305ee8de67b96a6b23d1e7.jpg"),
      color: "#595959",
    },
    {
      product: home("imgi_40_92434972b8204f999dff70ee525186c9.png"),
      bg: home("imgi_41_b056ac45fedb8d842f3490c97015ab22.jpg"),
      color: "#bca98b",
    },
    {
      product: home("imgi_42_4109a4a17cc7dcd14533f2cbf470b3c3.png"),
      bg: home("imgi_43_cc0b9edb1544694908e0cfe22563cef2.jpg"),
      color: "#152d3a",
    },
    {
      product: home("imgi_44_13a80d3f7ae7d04d629d49c8c2f8de35.png"),
      bg: home("imgi_45_594718eef1712bcb732def7522ed8c90.jpg"),
      color: "#a6a7a3",
    },
    {
      product: home("imgi_46_fe2569ab4447bec2c1d01e608885c8bc.png"),
      bg: home("imgi_47_046b7ca3308fd9d3fdbb0578577a9c96.png"),
      color: "#222a31",
    },
    {
      product: home("imgi_48_23433c6c5d1a5b113fab3a09ae6ab4bb.png"),
      bg: home("imgi_49_ca589a93d582796deda317af6f240438.jpg"),
      color: "#3d5054",
    },
    {
      product: home("imgi_50_00bbe483cfd95d3a77ea02d039c8f1e3.png"),
      bg: home("imgi_51_fbb3f29648098572226888c630239d69.jpg"),
      color: "#213e68",
    },
    {
      product: home("imgi_52_718f51e3a6c29211b8b20a1bed1d355a.png"),
      bg: home("imgi_53_d996f7284ad9a9649ceefabb8de2c97b.jpg"),
      color: "#71856a",
    },
    {
      product: home("imgi_54_cb57f4d055dcf2d6ae49f108c46afef9.png"),
      bg: home("imgi_55_36d6bbfe6aa4ab62028020c5ab49ceac.jpg"),
      color: "#5d8cad",
    },
    {
      product: home("imgi_56_dc0ca202cc69b2225d069a037c68be81.png"),
      bg: home("imgi_57_da670c7bc0945e9114981a0c11a1d7e0.jpg"),
      color: "#786e5a",
    },
    {
      product: home("imgi_58_f196207b671b11ed0058c564db36a27f.png"),
      bg: home("imgi_59_48dcbe933707bd002135e996991f2d30.jpg"),
      color: "#59631f",
    },
    {
      product: home("imgi_60_3ca38a32bb60e912e6cde193d5020efb.png"),
      bg: home("imgi_61_bd9122cf0ef1c48df453d139375baa79.jpg"),
      color: "#435b78",
    },
    {
      product: home("imgi_62_f99b0ba96368d16b8ea0cab30a65f778.png"),
      bg: home("imgi_63_8a716f8a5e48393fdd418e322287102c.jpg"),
      color: "#44484f",
    },
    {
      product: home("imgi_64_8f37773e59b31264f628582aca294258.png"),
      bg: home("imgi_65_2d2e6e86fd57794e1c8129d4ddbbb12b.jpg"),
      color: "#41406b",
    },
    {
      product: home("imgi_66_7f2a68230c09649ca7aab99e08d6653f.png"),
      bg: home("imgi_67_4ebd26fe63352cc5720de0bf5a7030f9.jpg"),
      color: "#22252c",
    },
    {
      product: home("imgi_68_12782f885af1c6d77a8354966bbb7db7.png"),
      bg: home("imgi_69_1539cd998476aa0f24975a8f6518ca2f.jpg"),
      color: "#c7a16f",
    },
    {
      product: home("imgi_70_c12fec95401abda9189e1ee81f6a3b2e.png"),
      bg: home("imgi_71_e760589ea6a7b283e54ea5fac728a49e.jpg"),
      color: "#4b321e",
    },
    {
      product: home("imgi_72_b8e67d929c6f67a4725afc339bf2a1c9.png"),
      bg: home("imgi_73_2bc4a5def9f2844ad2f891ac1bd59594.jpg"),
      color: "#b7ab9b",
    },
    {
      product: home("imgi_74_9d1176e01e3ff93b4e3bf4bd02ff0c4c.png"),
      bg: home("imgi_75_f9aa534e609d00e9a09fc99a48bc441f.jpg"),
      color: "#879bb1",
    },
    {
      product: home("imgi_76_33d8abbc43b9ebaa71fc527aed4ff4a8.png"),
      bg: home("imgi_77_d7ae82a057c5d428cd8dbf4dba0abf7b.jpg"),
      color: "#0a0b0d",
    },
    {
      product: home("imgi_78_72387a7f52a9c399fbfd3950f671cdaa.png"),
      bg: home("imgi_79_5d555f4809eb315598b75347e82d9e80.jpg"),
      color: "#5c697d",
    },
    {
      product: home("imgi_80_42e0e653629399c88a880c43b5d442c0.png"),
      bg: home("imgi_81_75373b758b45d987edea90b2f45318bc.jpg"),
      color: "#477994",
    },
    {
      product: home("imgi_82_85c7b1b1d3b47bd875005d9a880a610a.png"),
      bg: home("imgi_83_c8afb3ce395866e06079b5426842748b.jpg"),
      color: "#84afd0",
    },
    {
      product: home("imgi_84_642fdc118455d3b719384b7f990d90f5.png"),
      bg: home("imgi_85_01cb1cffcc87488bfdbe695a0d972fbf.jpg"),
      color: "#16240f",
    },
    {
      product: home("imgi_86_167aa78d106cd7ead497bb84fa123b70.png"),
      bg: home("imgi_87_283090155090a61b7051d6d3ae4d54a5.jpg"),
      color: "#111113",
    },
    {
      product: home("imgi_88_5167560f1e39d3c81ee682629e4b49b1.png"),
      bg: home("imgi_89_7bfcc25f3c38828ba9500ea27e783caa.jpg"),
      color: "#2f3d48",
    },
    {
      product: home("imgi_90_1ddba51d0a90aa701a1a66523692e651.png"),
      bg: home("imgi_91_674073269ae2a3f41855acbc1c813832.jpg"),
      color: "#0d0e12",
    },
  ],
...
const side = (label: string, image?: string, section?: string): SideItem => ({
  label,
  image,
  section,
});
...
const homeBannerItems: HomeBannerItem[] = [
  {
    ...
    image: asset.heroHome,
    baked: true,
  },
  {
    eyebrow: "Flagship Camera Drone",
    title: "DJI Mavic 4 Pro",
    subtitle: "See More. Tell More.",
    image: asset.droneHero,
  },
  {
    eyebrow: "All-in-One Vlog Camera Drone",
    title: "DJI Flip",
    subtitle: "Open New Possibilities",
    image: asset.droneAvata,
  },
  {
    eyebrow: "Professional Handheld Camera",
    title: "OSMO ACTION 6",
  ...
  },
  {
    ...
    subtitle: "See More. Tell More.",
    image: asset.fieldAgriculture,
  },
  {
    eyebrow: "Ready for Transport",
    title: "DJI FlyCart 100",
    subtitle: "Heavy Payload. Long Distance.",
    image: asset.fieldEnterprise,
  },
  {
    eyebrow: "Robot Vacuum",
    title: "ROMO",
    subtitle: "See More. Tell More.",
    image: asset.romo,
  },
...
const droneProducts = [
  ...
  p(
    ...
    asset.droneMini,
    "739",
    "All-in-One Flagship Mini Camera Drone",
  ),
  p(
    "DJI Air 3S",
    asset.droneBeach,
...
const handheldProducts = [
  p(
    ...
    asset.pocket,
    "543",
    "New 1-inch CMOS and 4K/240fps Slow Motion",
    "New",
  ),
...
const romoProducts = [
  p(
    "DJI ROMO P (Water Tank Version)",
    asset.romo,
    "1,219",
    "Flagship Robot Vacuum With Advanced Sensing",
    "New",
  ),
...
const educationProducts = [
  ...
  p(
    "Matrice 300 Series DJI Smart Controller Enterprise",
    asset.droneHero,
    "969",
    "",
    "Out of stock",
...
const refurbishedProducts = [
  ...
  p(
    "DJI Mini 4 Pro Fly More Combo Plus (Refurbished Unit)",
    asset.droneHero,
    "799",
  ),
...
const pageGroups: Record<StoreSection, ProductGroup[]> = {
  ...
  "camera-drones": [
    {
      title: "DJI Mavic 4 Pro",
      hero: droneProducts[0],
      products: droneProducts.slice(1, 6),
    },
    {
      title: "DJI Mavic 3 Pro",
      hero: p("DJI Mavic 3 Pro (DJI RC)", asset.droneBeach, "1,859"),
      products: accessoryProducts.slice(0, 5),
    },
    { title: "DJI Mavic 3 Classic", products: accessoryProducts.slice(2, 8) },
    {
      ...
      products: accessoryProducts
        .slice(5, 8)
        .concat(accessoryProducts.slice(0, 1)),
    },
  ],
  handheld: [
    {
      title: "Osmo Pocket 4",
      hero: handheldProducts[0],
      products: handheldProducts.slice(1, 5),
    },
    {
      title: "Osmo Pocket 3",
      hero: handheldProducts[4],
      products: handheldProducts.slice(2, 8),
    },
    {
      title: "DJI Pocket 2",
      products: handheldProducts.concat(accessoryProducts.slice(0, 4)),
    },
  ],
  "robot-vacuum": [
    {
  ...
  accessories: [
    ...
    { title: "DJI Mavic 3 Pro", products: accessoryProducts.slice(1, 8) },
    {
      ...
      products: accessoryProducts.concat(droneProducts.slice(0, 2)),
    },
  ...
  education: [
    {
      title: "Enterprise",
      products: educationProducts.concat(
        educationProducts,
        educationProducts.slice(0, 3),
      ),
    },
  ],
  refurbished: [
    {
      title: "Camera Drones",
      products: refurbishedProducts.concat(
        refurbishedProducts,
        refurbishedProducts.slice(0, 6),
      ),
    },
    {
      title: "Handheld",
      products: handheldProducts.concat(handheldProducts.slice(0, 1)),
    },
  ],
};
...
> = {
  ...
  education: {
    ...
    sideTitle: "",
    sideItems: [
      side("Enterprise", asset.droneHero),
      side("Education", asset.lito),
    ],
  ...
  refurbished: {
    ...
    sideTitle: "",
    sideItems: [
      side("Camera Drones", asset.droneNeo),
      side("Handheld", asset.pocket),
    ],
  ...
  const cameraRail = [
    {
      ...p(
        "DJI Lito 1",
        homeAsset.rail.camera[0],
        "299",
        "Beginner-Friendly Camera Drone",
        "New",
      ),
      gallery: [
        homeAsset.rail.camera[0],
        homeAsset.rail.camera[1],
        homeAsset.rail.camera[2],
      ],
    },
    {
      ...p(
        ...
        homeAsset.rail.camera[1],
        "399",
        "8K Flagship 360° Drone",
        "New",
      ),
      gallery: [
        homeAsset.rail.camera[1],
        homeAsset.rail.camera[2],
        homeAsset.rail.camera[3],
      ],
    },
    {
      ...p(
  ...
  const dailyRail = [
    {
      ...p(
        "Osmo Mobile 8P",
        homeAsset.rail.daily[0],
        "129",
        "Pro Framing and Tracking Phone Gimbal",
        "New",
      ),
      gallery: [
        homeAsset.rail.daily[0],
        homeAsset.rail.daily[1],
        homeAsset.rail.daily[2],
      ],
    },
    {
      ...p(
        ...
        homeAsset.rail.daily[1],
        "439",
        "All-In-One Flagship Action Camera",
      ),
      gallery: [
        homeAsset.rail.daily[1],
        homeAsset.rail.daily[2],
        homeAsset.rail.daily[3],
      ],
    },
    {
      ...p(
    ...
    },
    {
      ...p(
        ...
        homeAsset.rail.daily[3],
        "299",
        "Wearable Camera for Versatile Perspectives",
      ),
      gallery: [
        homeAsset.rail.daily[3],
        homeAsset.rail.daily[0],
  ...
  const proRail = [
    {
      ...p(
        "DJI RS 4 Mini",
        homeAsset.rail.pro[0],
        "268",
        "Compact and Lightweight Gimbal",
      ),
      gallery: [
        homeAsset.rail.pro[0],
        homeAsset.rail.pro[1],
        homeAsset.rail.pro[2],
      ],
    },
    {
      ...p(
        ...
        homeAsset.rail.pro[1],
        "889",
        "Expansive Flagship Stabilizer",
      ),
      gallery: [
        homeAsset.rail.pro[1],
        homeAsset.rail.pro[2],
        homeAsset.rail.pro[3],
      ],
    },
    {
      ...p("DJI Ronin 4D-6K", homeAsset.rail.pro[2], "5,299", "Cinema Camera"),
      gallery: [
        homeAsset.rail.pro[2],
        homeAsset.rail.pro[3],
        homeAsset.rail.pro[0],
    ...
    },
    {
      ...p(
        ...
        homeAsset.rail.pro[3],
        "309",
        "Portable Dual-Mode Video Transmission System",
      ),
      gallery: [
        homeAsset.rail.pro[3],
        homeAsset.rail.pro[0],
  ...
  return (
    <StoreShell home>
      <main className="store-home-main">
        ...
        <HomeIconStrip />
        <HomeCarousel />
        <h2 className="home-section-title">{tr("Camera Drones")}</h2>
        <HomeBand
          title="DJI Lito X1"
          image={homeAsset.cameraWide}
          to="/camera-drones"
        />
        <ProductRail
          products={cameraRail}
        ...
        <h2 className="home-section-title">
          {tr("Handheld · Daily Vlogging")}
        </h2>
        <HomeBand
          title="Osmo Pocket 4"
          image={homeAsset.dailyWide}
          to="/handheld"
        />
        <ProductRail
          products={dailyRail}
        ...
        />
        <h2 className="home-section-title">{tr("Handheld · Pro Shooting")}</h2>
        ...
        <section className="home-education-block">
          <div className="home-module-heading">
            <h2 className="home-section-title">{tr("Education & Industry")}</h2>
            <ScrollButtons target="home-education" />
          </div>
          <div data-scroll="home-education">
            <ArticleCard
              title="Enterprise"
              subtitle="Integrated drone-based industrial solutions"
              image={homeAsset.educationEnterprise}
            />
            <ArticleCard
              title="Education"
              subtitle="Programming education solutions"
              image={homeAsset.educationClassroom}
            />
          </div>
        </section>
        <section className="store-playbook">
          <div className="home-module-heading">
            <h2>{tr("Buying Guides")}</h2>
          ...
          <div data-scroll="home-guides">
            {homeAsset.buyingGuides.map((image, index) => (
              <ArticleCard
                ...
                title={
                  [
                    "DJI Mini 4 Pro vs. DJI Air 3S vs. DJI Mavic 3 Pro",
                    "Follow Me Drones 2024",
                    "DJI Air 3S vs DJI Air 3",
                    "Osmo Action 5 Pro Unboxing",
                    "DJI Power 1000 V2 vs. DJI Power 1000",
                    "Follow Me Drones 2025",
                    "DJI Neo vs. DJI Flip",
                    "Osmo 360 vs. X5",
                    "Vlogging Reinvented",
                    "FPV Drones 2024",
                    "DJI Mini 4 Pro vs. Mini 3 Pro",
                    "Mini Drones: The Definitive Guide",
                    "Best Action Camera in 2024",
                    "DJI Air 3 vs Air 2S vs Mini 3 Pro",
                    "DJI Mavic 3 Pro vs. Mavic 3 vs. Mavic 3 Classic",
                    "Mavic 3 Pro: EPIC ROBOTIC SHOTS",
                    "DJI Mini 2 SE vs DJI Mini SE vs DJI Mini 3",
                    "Must-Have Gear for Camping Photographers",
                    "Best Action Cameras: In-depth Buying Guide",
                    "DJI RS 3 Mini: Unboxing & Highlights",
                  ][index] || "Buying Guide"
                }
...
function HomeWideBanner({
  ...
  return (
    <section
      className={`home-wide-banner is-composite ${light ? "light" : ""}`}
      style={{ backgroundImage: `url(${image})` }}
    >
      <p>{tr(eyebrow)}</p>
      <h2>{tr(title)}</h2>
      <span>{tr(subtitle)}</span>
      <Link to="/products">{tr(cta)}</Link>
    </section>
  );
}
...
export function OfficialHomePage() {
  ...
  const visibleHeroTitles = [-1, 0, 1].map((offset) => {
    const index =
      (heroIndex + offset + homeBannerItems.length) % homeBannerItems.length;
  ...
  return (
    <StoreShell home>
      <main className="official-home-main">
        <section
          className={`official-hero ${activeHero.baked ? "is-baked" : ""}`}
          style={{ backgroundImage: `url(${activeHero.image})` }}
        >
          <div className="official-hero-copy">
            <p>{tr(activeHero.eyebrow)}</p>
            <h1>{tr(activeHero.title)}</h1>
            <span>{tr(activeHero.subtitle)}</span>
            <div>
              <Link to="/products">{tr("Learn More")}</Link>
              <Link to="/products">{tr("Buy Now")}</Link>
            </div>
          </div>
          ...
          <div className="official-hero-specs">
            <span>249 g</span>
            <span>45 min</span>
            <span>Omnidirectional Sensing</span>
          </div>
        </section>
        <HomeWideBanner
          ...
          image={asset.storeDay}
        />
        <HomeWideBanner
          eyebrow="Immersive Recording Mini Wireless Mic"
        ...
        <section className="home-shot-section">
          ...
          <HomeFeatureCard
            title="Shot on Osmo Mobile 8P"
            subtitle="Learn More / Buy Now"
            image={asset.shotMobile}
          />
          <button aria-label="Next">&gt;</button>
        </section>
        <section className="home-innovation">
          <h2>{tr("Standing at the Forefront of Innovation")}</h2>
          <p>
            {tr(
          ...
          <div>
            ...
            <HomeFeatureCard
              ...
              subtitle="Learn More"
              image={asset.innovationRight}
            />
          </div>
        </section>
        <section className="home-fields">
          <h2>{tr("Explore DJI Products in Different Fields")}</h2>
          <div>
            <HomeFeatureCard
...
function HomeFeatureGrid() {
  ...
  const tiles = [
    ...
    [
      '1" CMOS Pocket Gimbal Camera',
      "OSMO POCKET 4",
      "The World in My Pocket",
      asset.pocket,
    ],
    [
      "8K Flagship 360 Degree Drone",
      "DJI AVATA 360",
    ...
    [
      "Pro Framing and Tracking Phone Gimbal",
      "OSMO MOBILE 8P",
      "Wonders in Your Palm",
      asset.mobile,
    ],
    [
      "Product Info",
      "Compare Camera Drones",
...
export function StoreCategoryPage({ section }: { section: StoreSection }) {
  ...
  const isListing =
    section === "education" ||
    section === "services" ||
    section === "robot-vacuum";
  const products = listingProducts(section, groups);

  return (
    <StoreShell>
      <main
        className={`store-list-page store-list-${section} ${isListing ? "catalog" : ""}`}
      >
        <h1>{tr(titleMap[section])}</h1>
        {section === "education" && (
          <div className="store-tabs">
            <span className="active">{tr("Enterprise")}</span>
        ...
        <div className="store-catalog-layout">
          ...
          <section className="store-product-area">
            <div className="store-sort">
              <span>
                {products.length} {tr("Item(s) Found")}
              </span>
              <button>{tr("Sort by: Recommendation")} v</button>
            </div>
...
function StoreDayPage() {
  ...
  const saleProducts = [
    ...
    romoProducts[0],
    p("Osmo Mobile 8P", asset.mobile, "129"),
    p("DJI Air 3S", asset.droneBeach, "926"),
  ];
  ...
  return (
    <StoreShell>
      <main className="store-day-page">
        <section
          className="store-day-hero"
          style={{ backgroundImage: `url(${asset.storeDay})` }}
        >
          <div>
            <p>June 1 - June 8</p>
            <h1>DJI STORE DAY</h1>
            <span>{tr("Up to 30% Off")}</span>
          </div>
        </section>
        ...
        <section className="why-shop">
          {[
            ...
            "Exclusive Gift",
            "Earn 5% in DJI Credit",
            "Accessory Coupon",
          ].map((item) => (
            <article key={item}>
              <h3>{item}</h3>
              <p>{tr("Exclusive benefits for DJI Store members.")}</p>
            </article>
          ))}
        </section>
        <h2>{tr("Curated Picks")}</h2>
        <div className="sale-grid">
          {curated.map((product, index) => (
            <PromoProduct
              key={`${product.name}-curated-${index}`}
              product={product}
              index={index}
            />
          ))}
        </div>
        <h2>{tr("Exclusive Privileges")}</h2>
        <div className="sale-grid two">
          {privileges.map((product, index) => (
            <PromoProduct
              key={`${product.name}-privilege-${index}`}
              product={product}
              index={index}
            />
          ))}
        </div>
        <h2>{tr("News Refresh")}</h2>
        <div className="sale-grid news">
          {news.map((product, index) => (
            <PromoProduct
              key={`${product.name}-news-${index}`}
              product={product}
              index={index}
            />
          ))}
        </div>
        <h2>{tr("Officially Refurbished, Quality Guaranteed")}</h2>
        <div className="sale-refurb-row">
          {refurbishedProducts.slice(0, 6).map((product) => (
    ...
    <>
      <div className="store-topbar">
        <div>
          ...
          <span>
            Virtual Flight is now available - A must-try for beginners! Download
            the <b>DJI Store app</b> and experience the thrill of flying.
          </span>
        </div>
        <div className="store-locale">
          <LanguageSelector />
        </div>
      </div>
      <header
        className={`store-nav ${home ? "official-nav" : ""} ${transparent ? "is-transparent" : ""} ${scrolled ? "is-scrolled" : ""} ${mobileMenuOpen ? "has-mobile-menu" : ""}`}
      >
        <button
          type="button"
        ...
        <nav>
          <Link
            className={pathname === "/store-day" ? "active" : ""}
            to="/store-day"
          >
            {tr("DJI STORE DAY")}
          </Link>
            ...
            <div className="more-menu" onMouseEnter={() => setOpenPanel(null)}>
              ...
              {moreOpen && (
                <div>
                  ...
                  <Link to="/official-refurbished">Official Refurbished</Link>
                </div>
              )}
            </div>
          )}
        ...
        <div className="store-actions">
          ...
          <Link to={user ? "/orders" : "/login"} aria-label="Account">
            <UserIcon />
          </Link>
        </div>
      </header>
      {mobileMenuOpen && (
        <section
          className={`mobile-nav-panel ${home ? "official-mobile-panel" : ""}`}
        >
          <p>
            Virtual Flight is now available - A must-try for beginners! Download
            the <b>DJI Store app</b> and experience the thrill of flying.
          ...
          <div className="mobile-nav-secondary">
            {["dji.com", "DJI Store APP", "Guides", "DJI Credit"].map(
              (item) => (
                <Link key={item} to="/">
                  {item} <span>&gt;</span>
                </Link>
          ...
          <div className="mobile-locale">
            <LanguageSelector onChanged={() => setMobileMenuOpen(false)} />
          </div>
        </section>
      )}
      {openPanel && (
        <MegaPanel panelKey={openPanel} onClose={() => setOpenPanel(null)} />
      )}
      {openPanel && (
        <button
...
function MegaPanel({
  ...
  return (
    <section
      className={`mega-panel mega-${panelKey}`}
      data-menu={panelKey}
      onMouseEnter={() => undefined}
    >
      <button className="mega-close" onClick={onClose} aria-label={tr("Close")}>
        x
      </button>
      <aside>
        {meta.sideTitle && <p>{tr(meta.sideTitle)}</p>}
        {meta.sideItems.map((item) => (
          <div
            key={`${item.section || ""}-${tr(item.label)}`}
            className="mega-side-row-wrap"
          >
        ...
        <Link className="view-all" to={meta.path}>
          {tr("View All")} {tr(meta.label)} &gt;
        </Link>
      </aside>
      <div className="mega-products">
        {meta.groups.map((group) => (
          <ProductGroupView key={group.title} group={group} compact />
        ))}
      </div>
    </section>
  );
...
function ProductGroupView({
  ...
  return (
    <section className={`store-product-group ${compact ? "compact" : ""}`}>
      <h2>
        {tr(group.title)} <Link to="/products">{tr("View all")} &gt;</Link>
      </h2>
      <div className={group.hero ? "group-grid has-hero" : "group-grid"}>
        ...
        {compact && (
          <Link className="view-card" to="/products">
            <span>-&gt;</span>
            <p>{tr("View all")}</p>
          </Link>
        )}
...
function ProductCard({
  ...
  return (
    <Link
      to="/products"
      className={`store-product-card ${featured ? "featured" : ""}`}
    >
      <div className="product-card-media">
        ...
        {gallery.length > 1 && (
          <>
            <button
              className="product-media-arrow left"
              type="button"
            ...
            <button
              className="product-media-arrow right"
              type="button"
            ...
            <div
              className="product-media-progress"
              aria-label={`${product.name} image pagination`}
            >
      ...
      {product.tag && (
        <span className={product.tag === "Out of stock" ? "muted" : ""}>
          {tr(product.tag)}
        </span>
      )}
      <h3>{product.name}</h3>
      {product.desc && <p>{tr(product.desc)}</p>}
...
function MarketingCategory({ section }: { section: StoreSection }) {
  ...
  const sceneImages = camera
    ? [asset.droneBeach, asset.droneAvata, asset.droneHero]
    : [asset.action, asset.ronin, asset.fieldVideo];
  const sceneTitles = camera
    ? ["Aerial Photography", "Immersive Flight", "Aerial Cinematic Tools"]
    : ["Daily Vlogs", "Professional Creation", "Professional Accessories"];
  const playbookImages = camera
    ? [asset.droneBeach, asset.droneHero, asset.droneAvata, asset.action]
    : [asset.action, asset.bike, asset.dive, asset.travel];
  const playbookTitles = camera
    ? [
        "Essential Accessories for DJI Avata 2",
        "DJI Avata First Use",
        "Mini 4 Pro: A Skyward Upgrade",
        "The Ultimate Mavic Series Accessory Guide",
      ]
    : [
        "Pick Your Wireless Microphone",
        "Pick Your Action Cams & Mounts",
        "Essential Accessories for Osmo Pocket 3",
        "From Dusk Till Dawn With Osmo Action 4",
      ];
  return (
    <section className={`compare-page compare-${section}`}>
      <h1>{tr(camera ? "Camera Drones" : "Camera & Gimbal")}</h1>
      <p>
        {tr(
          camera
            ? "Unlock adventure in the sky"
            : "Discover the ideal DJI camera, gimbal, and accessories tailored for your daily vlogs or pro-level content creation.",
        )}
      </p>
      <div className="compare-scenes">
        {sceneTitles.map((title, index) => (
          <ArticleCard key={title} title={title} image={sceneImages[index]} />
        ))}
      </div>
      <h2>Which {camera ? "Drone" : "Camera or Gimbal"} Is Right for Me?</h2>
      <ProductRail
        products={
          camera ? droneProducts.slice(1, 5) : handheldProducts.slice(0, 4)
        }
      />
      <h2>{camera ? "Image Quality" : "Imaging Performance"}</h2>
      <SpecComparison camera={camera} />
      <h2>
        {camera ? "Safety & Flight Performance" : "Main Body Performance"}
      </h2>
      <SpecComparison camera={camera} />
      {camera && (
        <ProductRail
      ...
      {camera ? (
        ...
        <section className="marketing-cards">
          ...
          <div>
            {[asset.action, asset.bike, asset.dive, asset.travel].map(
              (image, index) => (
                <ArticleCard
                  key={`${image}-activity-${index}`}
                  title={["Vlog", "Biking", "Diving", "Travel"][index]}
                  image={image}
                />
              ),
            )}
      ...
      {!camera && (
        <section className="marketing-video">
          ...
          <ArticleCard
            title="Cycling is a feeling as natural as breathing"
            image={asset.fieldVideo}
          />
        </section>
      )}
      <section className="marketing-cards">
        <h2>
          {camera ? "Camera Drones Playbook" : "Camera & Gimbal Playbook"}
        </h2>
        <div>
  ...
  return (
    <div className="spec-table">
      {specs.map((spec, index) => (
        <article key={`${spec}-${index}`}>
          <strong>{spec}</strong>
          <span>
            {index < 4 ? "Imaging Performance" : "Main Body Performance"}
          </span>
        </article>
      ))}
    </div>
...
function HomeHero() {
  ...
  const slides: HomeBannerItem[] = [
    {
      eyebrow: "June 1 - June 14",
      title: "DJI STORE DAY",
      subtitle: "Up to 30% Off",
      image: home("imgi_1_3e2f77565f1e91253031790a6844338d.png"),
      cta: "Buy Now",
      light: true,
    },
    {
    ...
    },
    {
      ...
      title: "DJI MIC MINI 2S",
      subtitle: "Capture Every Detail",
      image: home("imgi_3_ae9b431ffcb2bc8ba2b3d086a3b60938.jpg"),
      cta: "Learn More",
    },
    {
      title: "My Pocket View",
      subtitle: "Claim up to $800 DJI Credit.",
      image: home("imgi_2_78c4ee1b728cbcbec7047a91822ee991.jpg"),
      cta: "Learn more",
      light: true,
    },
  ];
  ...
  return (
    <section
      className={`store-hero home-hero-slide ${active.light ? "light-copy" : ""}`}
  ...
  const benefits: StoreBenefit[] = [
    {
      ...
      image: homeAsset.credit,
      detail:
        "Earn DJI Credit with eligible DJI Store purchases and redeem it toward future orders.",
    },
    {
      title: "Up to 30-Day Returns",
      image: homeAsset.returns,
      imageClass: "benefit-symbol returns",
      detail:
        "Enjoy up to 30-day returns on eligible products purchased from DJI Store.",
    },
    {
      title: "Over USD $45 Ships Free",
      image: homeAsset.freeShipping,
      imageClass: "benefit-symbol free",
      detail:
        "Orders over USD $45 ship free, with tracking provided after dispatch.",
    },
    {
      title: "Get DJI Expert Help",
      image: homeAsset.expert,
      detail:
        "Chat with DJI experts for product selection, order questions, and setup guidance.",
    },
    {
      title: "Official Refurbished",
      image: homeAsset.refurbished,
      detail:
        "Shop certified refurbished DJI products inspected to official quality standards.",
    },
    {
      title: "Official Accessories",
      image: homeAsset.accessories,
      detail:
        "Choose genuine DJI accessories designed for reliable compatibility and performance.",
    },
  ];
  ...
  const fresh = [
    {
      name: "Osmo Pocket 3",
      price: "358",
      desc: "1″ CMOS Pocket Gimbal Camera",
    },
    {
      name: "Osmo Mobile 8P",
      price: "129",
      desc: "Pro Framing and Tracking Phone Gimbal",
    },
    { name: "DJI Mic Mini 2", price: "54", desc: "Mini Wireless Microphone" },
    {
      name: "DJI Lito X1",
      price: "369",
      desc: "Beginner-Friendly Premium Camera Drone",
    },
    {
      name: "DJI Lito 1",
      price: "299",
      desc: "Beginner-Friendly Camera Drone",
    },
    {
      name: "Osmo Pocket 4",
      price: "473",
    ...
    { name: "DJI Avata 360", price: "399", desc: "8K Flagship 360° Drone" },
    {
      name: "DJI ROMO",
      price: "899",
      desc: "Flagship Robot Vacuum With Advanced Sensing",
    },
    {
      name: "DJI RS 5",
      price: "519",
      desc: "Lightweight Commercial Stabilizer",
    },
    {
      name: "Osmo Action 6",
      price: "439",
      desc: "All-In-One Flagship Action Camera",
    },
    ...
    { name: "Osmo Mobile 8", price: "83", desc: "360 Tracking Phone Gimbal" },
    {
      name: "Osmo Nano",
      price: "299",
      desc: "Wearable Camera for Versatile Perspectives",
    },
    {
      name: "DJI Mini 5 Pro",
      price: "739",
      desc: "All-In-One 1-Inch Large CMOS Mini Camera Drone",
    },
    {
      name: "DJI Mic 3",
      price: "149",
      desc: "Advanced Mini Wireless Microphone",
    },
    ...
    },
    {
      name: "DJI RS 4 Mini",
      price: "268",
      desc: "Compact and Lightweight Gimbal for Content Creators",
    },
    { name: "DJI Flip", price: "329", desc: "All-in-One Vlog Camera Drone" },
    {
      name: "Osmo Mobile 7P",
      price: "94",
      desc: "Flagship Intelligent Tracking Phone Gimbal",
    },
    { name: "DJI Mic Mini", price: "39", desc: "Mini Wireless Microphone" },
    {
      name: "DJI O4 Air Unit Pro",
      price: "100",
      desc: "Flagship FHD FPV Digital Video Transmission",
    },
    {
      name: "Osmo Action 5 Pro",
      price: "306",
      desc: "The Action Camera With Revolutionary Image Quality",
    },
    { name: "DJI Neo", price: "139", desc: "A Palm-Sized Drone for Vlogs" },
    {
      name: "DJI Mini 4K",
      price: "226",
      desc: "In Stock - Easy-To-Use Mini Camera Drone",
    },
    {
      name: "DJI Mini 3",
      price: "227",
      desc: "In Stock - Premier Entry-Level Camera Drone",
    },
    {
      name: "DJI Mini 4 Pro",
      price: "629",
      desc: "All-In-One Omni Obstacle Sensing Mini Camera Drone",
    },
    {
      name: "DJI Air 3S",
      price: "926",
      desc: "Dual-Camera Drone for Travel Photography",
    },
    { name: "DJI Avata 2", price: "729", desc: "FPV Drone" },
    {
      name: "DJI RS 4 Pro",
      price: "889",
      desc: "Expansive Flagship Stabilizer",
    },
  ].map((item, itemIndex) => ({
    ...p(
      item.name,
      homeAsset.whatsNew[itemIndex].product,
      item.price,
      item.desc,
    ),
    ...
    <>
      <section className="whats-new">
        ...
        <div data-scroll="whats-new">
          {fresh.map((product) => (
            <HomeNewCard key={product.name} product={product} />
          ))}
        </div>
      </section>
      ...
      <Link
        ...
        to="/store-day"
        style={{ backgroundImage: `url(${homeAsset.storeDay})` }}
      >
        <span>{tr("Up to 30% Off")}</span>
...
function HomeNewCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      style={
        {
          backgroundImage: `url(${product.bgImage || product.image})`,
          "--card-color": product.bgColor || "#575857",
        } as CSSProperties
      }
    >
      {product.bgImage && (
        <img className="home-new-product" src={product.image} alt="" />
      )}
      <h3>{product.name}</h3>
      <p>{product.desc}</p>
      <span>From USD ${product.price}</span>
      <button>{tr("Buy Now")}</button>
    </Link>
  );
}
    ...
    <section className="home-product-rail-wrap">
      ...
      <div className="product-rail" data-scroll={target}>
        ...
        <div className="rail-guide-stack">
          <Link
            className={`guide-card ${guideImage ? "with-image" : ""}`}
            to="/products"
            style={
              guideImage ? { backgroundImage: `url(${guideImage})` } : undefined
            }
          >
...
function FilterSidebar({ section }: { section: StoreSection }) {
  ...
  const items =
    section === "robot-vacuum"
      ? ["DJI ROMO"]
      : section === "services"
        ? ["Inspire", "Ronin Cinema Cameras"]
        : ["DJI Mavic", "M30", "Developer Tools", "M300", "Software", "Livox"];
  return (
    <aside className="filter-sidebar">
      <h3>{tr("Filter")}</h3>
      <strong>{tr("Product Series")}</strong>
      {items.map((item) => (
        <label key={item}>
          <input type="radio" /> {item}
        </label>
      ))}
      <strong>{tr("Product Types")}</strong>
      <label>
        <input type="checkbox" /> {tr("Main Products")}
      </label>
      <label>
        <input type="checkbox" /> {tr("Accessory")}
      </label>
    </aside>
  );
}
...
function RefurbishedHero() {
  ...
  return (
    <section className="refurb-hero">
      <div>
        <h2>{tr("OFFICIAL REFURBISHED")}</h2>
        <p>{tr("Up to 30% Off. Certified Quality, Guaranteed.")}</p>
      </div>
      <img src={asset.mobile} alt="" />
    </section>
  );
}
    ...
    <StoreShell>
      <main className="refurbished-page">
        ...
        <section className="refurb-info">
          <h2>{tr("Why Refurbished Products?")}</h2>
          <p>
            {tr(
              "Official refurbished products are tested to DJI standards and come with support for essential store services.",
            )}
          </p>
          <Link to="/products">{tr("Learn More")}</Link>
        </section>
        ...
        <section className="refurb-faq">
          <h2>{tr("Let's Answer Your Questions")}</h2>
          {[
            "Where do refurbished products come from?",
            "Is the quality of a refurbished product guaranteed?",
            "What is the difference between refurbished and new products?",
            "How should I choose a refurbished product?",
          ].map((item) => (
            <details key={item} open>
              <summary>{item}</summary>
              <p>
                Every official refurbished product is inspected, cleaned, and
                covered by DJI Store support.
              </p>
            </details>
          ))}
        </section>
          ...
          <article key={`${product.name}-${index}`} className="refurb-card">
            ...
            <div>
              ...
              <p>
                {tr(
                  product.desc ||
                    "Official refurbished product inspected by DJI.",
                )}
              </p>
...
function PromoProduct({ product, index }: { product: Product; index: number }) {
  ...
  return (
    <article className="promo-card">
      <div className="sale-tag">Save {index % 3 === 0 ? "30%" : "15%"}</div>
      <img src={product.image} alt={product.name} />
      <h3>{product.name}</h3>
      <p>{tr(product.desc || "Limited-time exclusive offer")}</p>
      <strong>USD $ {product.price}</strong>
      <button>{tr("Buy Now")}</button>
    </article>
  );
...
function TrustStrip() {
  ...
  const items = [
    ...
    {
      icon: <CardIcon />,
      content: <>We accept credit cards, PayPal, and bank wires</>,
    },
    {
      icon: <ChatIcon />,
      content: (
        <>
          Order Service: <Link to="/support">Live Chat</Link>
        </>
      ),
    },
  ];
...
function TruckIcon() {
  return (
    ...
    >
      <path
        d="M3 7h11v9H3zM14 10h3.5L21 13v3h-7zM7 19a1.6 1.6 0 1 0 0-3.2A1.6 1.6 0 0 0 7 19Zm10 0a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2Z"
  ...
  return (
    <footer className="store-footer">
      <div className="store-footer-top">
        <strong>{tr("Product Categories")}</strong>
        <nav>
          {cols.map((col) => (
            <Link key={col[0]} to="/products">
              {col[0]}
            </Link>
          ))}
        </nav>
        <span>{tr("Singapore English")}</span>
      </div>
        ...
        <section className="store-footer-subscribe">
          ...
          >
            <input
              ...
              aria-label={tr("Your Email Address")}
            />
      ...
      <div className="store-footer-bottom">
        <Link className="footer-logo" to="/">
          <img src="/logo-black.webp" alt="DJI" />
        </Link>
        <nav>
          {["Who We Are", "Contact Us", "Careers", "Flagship Stores"].map(
            (item) => (
              <Link key={item} to="/products">
                {tr(item)}
              </Link>
      ...
      <div className="store-footer-legal">
        <small>
          <span>{tr("Copyright © 2026 DJI All Rights Reserved.")}</span>
          {[
            "Privacy Policy",
        ...
        <Link to="/support">
          {tr("Feedback on web experience? Click here")}
        </Link>
      </div>
    </footer>
  );
  ...
  return (
    <footer className="official-footer">
      <section className="official-app-banner">
        <strong>{tr("Only in the DJI Store App")}</strong>
        <p>
          {tr(
            "Try virtual flight online for fun, and enjoy convenient one-stop device services.",
          )}
        </p>
        <Link to="/products">{tr("Download App")}</Link>
      </section>
      ...
      <div className="official-footer-bottom">
        <Link className="footer-logo" to="/">
          <img src="/logo-white.webp" alt="DJI" />
        </Link>
        <nav>
          {[
            "Who We Are",
      ...
      <small>
        Copyright 2026 DJI All Rights Reserved. Privacy Policy / Terms of Use /
        Site Map
      </small>
    </footer>
  );
...
function FloatingHelp() {
  ...
  return (
    <div className="floating-help">
      ...
      <button type="button" aria-label="Customer service">
        <SupportAvatarIcon />
      </button>
      <button type="button" aria-label="Support center">
        <SupportBoxIcon />
      </button>
    </div>
  );
...
function FacebookIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M14.3 8.1h2.1V4.8a27 27 0 0 0-3-.1c-3 0-5 1.8-5 5v2.8H5.1v3.7h3.3v7.6h4v-7.6h3.3l.5-3.7h-3.8V10c0-1.1.3-1.9 1.9-1.9Z" />
    </svg>
  );
}
...
function XIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="m13.8 10.4 6.4-7.1h-2.1l-5.2 5.8-4.2-5.8H3.3l6.7 9.1-6.8 7.6h2.1l5.6-6.2 4.5 6.2h5.4l-7-9.6Zm-2.2 2.4-.9-1.2-4-5.7h1.2l3.3 4.6.9 1.2 4.3 6h-1.2l-3.6-4.9Z" />
    </svg>
  );
}
...
function YouTubeIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M21.4 7.2a2.6 2.6 0 0 0-1.8-1.8C18 5 12 5 12 5s-6 0-7.6.4a2.6 2.6 0 0 0-1.8 1.8A27 27 0 0 0 2.2 12a27 27 0 0 0 .4 4.8 2.6 2.6 0 0 0 1.8 1.8C6 19 12 19 12 19s6 0 7.6-.4a2.6 2.6 0 0 0 1.8-1.8 27 27 0 0 0 .4-4.8 27 27 0 0 0-.4-4.8ZM10 15V9l5.2 3L10 15Z" />
    </svg>
  );
}
...
function SupportAvatarIcon() {
  return (
    <svg viewBox="0 0 40 40" aria-hidden="true">
      <circle cx="20" cy="20" r="20" fill="#edf1f4" />
      <circle cx="20" cy="14" r="6" fill="#27323a" />
      <path d="M9 35c1.6-7.4 5.2-11 11-11s9.4 3.6 11 11" fill="#27323a" />
      <path
        d="M12 33c2.2-4.8 4.8-7.2 8-7.2s5.8 2.4 8 7.2"
        fill="#f0c7a1"
        opacity=".9"
      />
    </svg>
...
function SupportBoxIcon() {
  return (
    ...
    >
      <path
        d="M6 7.4 12 4l6 3.4v7.2L12 18l-6-3.4V7.4Z"
        strokeLinejoin="round"
      />
      <path
        d="m6 7.5 6 3.5 6-3.5M12 11v7M9.2 14.8h5.6"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
function flatProducts(groups: ProductGroup[]) {
  return groups.flatMap((group) =>
    group.hero ? [group.hero, ...group.products] : group.products,
  );
}
...
function CartIcon() {
  return (
    <svg viewBox="0 0 24 24">
      <path d="M7 18.5a1.6 1.6 0 1 0 0 3.2 1.6 1.6 0 0 0 0-3.2Zm10 0a1.6 1.6 0 1 0 0 3.2 1.6 1.6 0 0 0 0-3.2ZM5.2 5l1.6 8.4h9.7l1.7-6.2H8.4L8 5H5.2Zm-2.1-2h4.5l.5 2.2h12.7l-2.8 10.2H5.2L3.1 3Z" />
    </svg>
  );
}
...
function GlobeIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18Zm0-1.8c.9-1 1.7-2.5 2.1-4.2H9.9c.4 1.7 1.2 3.2 2.1 4.2Zm-2.5-6h5a12 12 0 0 0 0-2.4h-5a12 12 0 0 0 0 2.4Zm-4.6 0h2.8a15 15 0 0 1 0-2.4H4.9a7.1 7.1 0 0 0 0 2.4Zm11.4 0h2.8a7.1 7.1 0 0 0 0-2.4h-2.8a15 15 0 0 1 0 2.4Zm-6.4-4.2h4.2C13.7 7.3 12.9 5.8 12 4.8c-.9 1-1.7 2.5-2.1 4.2Zm6.1 0h2.5a7.3 7.3 0 0 0-4-3.5c.6 1 1.1 2.2 1.5 3.5Zm-10.5 0H8c.4-1.3.9-2.5 1.5-3.5a7.3 7.3 0 0 0-4 3.5Zm9 9.5a7.3 7.3 0 0 0 4-3.5H16c-.4 1.3-.9 2.5-1.5 3.5Zm-5 0A13.7 13.7 0 0 1 8 15H5.5a7.3 7.3 0 0 0 4 3.5Z" />
    </svg>
  );
}
